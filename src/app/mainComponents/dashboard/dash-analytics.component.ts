...
import { NewCustomerScreenComponent } from '../new-customer-screen/new-customer-screen.component';
...
@Component({
  ...
  standalone: true,
  imports: [SharedModule, NgApexchartsModule, NewCustomerScreenComponent],
